    ...
    return (
        <div className="relative mt-2 grid grid-cols-12 gap-5">
            {contents.map((project, index) => (
                <motion.div
                    className="col-span-12 rounded-2xl border bg-base-300 bg-gradient-to-r from-blue-400 to-purple-400 p-1 max-[319px]:w-[11rem] sm:col-span-8 md:col-span-6 lg:col-span-4"
                    key={index}
