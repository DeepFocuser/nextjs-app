...
export const projects: IProject[] = [{
    ...
    description: 'This page is the first page created by DeepFocuser using Next.js and shows  <strong class=\'text-red-500\'>the results of operating self-made AI models on the web</strong> and also shows <strong class=\'text-blue-500\'>DeepFocuser\'s career.</strong>',
