...
export const projects: IProject[] = [
    ...
    },
    {
        ...
        image_path: '/images/projects/deeplearning.png',
    ...
    },
    {
        ...
        description:
            "This page is the first page created by DeepFocuser using Next.js and shows the results of operating self-made AI models on the web and also shows DeepFocuser's career.",
        image_path: '/images/projects/transformer.png',
    ...
    {
        name: 'Torchserving Project',
        description:
            "This page is the first page created by DeepFocuser using Next.js and shows the results of operating self-made AI models on the web and also shows DeepFocuser's career.",
        image_path: '/images/projects/torchserving.png',
