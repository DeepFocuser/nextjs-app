...
export default function Layout({children}: { children: ReactNode }) {
    ...
    return (
        <>
            <div className="mx-auto mb-36 px-4 py-8 sm:px-6 sm:py-8 lg:px-8 max-[1024px]:hidden">
            ...
            <div className="mx-auto mb-36 px-4 py-8 sm:px-6 sm:py-8 lg:px-8 min-[1024px]:hidden"
                 ref={targetRef}>
                <div className="text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
                    <h1 className="text-2xl font-bold sm:text-3xl">
                        DeepFocuser Portfolio
