...
function Home() {
    ...
    const handlerFilterCategory = useCallback<(category: Category | 'All') => void>((category) => {
        if (category === 'All') {
    ...
    return (
        <div
            className="projects-scrollbar max-h-[37rem] overflow-y-scroll px-4 lg:max-h-[38rem] xl:max-h-[39.25rem] 2xl:max-h-[36rem]">
            <ProjectsNavbar
