        ...
        <div className="mx-auto mb-36 px-4 py-8 sm:px-6 sm:py-8 lg:px-8 lg:py-8">
            <div className="grid gap-y-8 lg:gap-x-16">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-1 md:gap-12 lg:grid-cols-1">
                    ...
                    <div
                        className="block rounded-xl border border-green-300/10 p-8 shadow-xl shadow-green-300/10 transition hover:shadow-green-300">
                        <span className="inline-block rounded-lg p-3">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <Link
                            href="/humanmatting"
                            className="btn-accent bg-green-500 btn-xs btn mr-2 mt-2 normal-case"
                        >
                            HumanMatting
                        </Link>
                        <Link
                        ...
                        <Link
                            href="/facedetection"
                            className="btn-secondary bg-orange-500 btn-xs btn mr-2 mt-2 normal-case"
                        >
                            Face Detection
                        </Link>
                        <Link
                        ...
                        <Link
                            href="/posedetection"
                            className="btn-primary bg-blue-500 btn-xs btn mr-2 mt-2 normal-case"
                        >
                            Pose Detection
                        </Link>
                    </div>
