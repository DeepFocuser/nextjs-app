            ...
            <div className="navbar-start">
                ...
                <ul className="container steps mx-auto hidden md:steps-horizontal md:block md:inline-grid">
                    <li data-content="✅" className="step-neutral step">
                        ...
                        >
                            <div className="tooltip tooltip-right" data-tip="HumanMatting">
                                Hm
                            </div>
                        </Link>
                    </li>
                    <li data-content="✅" className="step-neutral step">
                        <Link
                            ...
                            className="btn-accent btn-sm btn text-xs normal-case"
                        >
                            <div className="tooltip tooltip-right" data-tip="HumanMatting better">
                                Hm b
                            </div>
                        </Link>
                    </li>
                    <li data-content="✅" className="step-neutral step">
                        <Link
                            ...
                            className="btn-accent btn-sm btn text-xs normal-case"
                        >
                            <div className="tooltip tooltip-left" data-tip="FaceDetection">
                                Face
                            </div>
                        </Link>
                    </li>
                    <li data-content="✅" className="step-neutral step">
                        <Link
                            ...
                            className="btn-accent btn-sm btn text-xs normal-case"
                        >
                            <div className="tooltip tooltip-left" data-tip="VoiceActivityDetection">
                                Voice
                            </div>
                        </Link>
                    </li>
