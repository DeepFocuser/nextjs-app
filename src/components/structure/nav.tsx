            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start lg:hidden">
                    <div className="dropdown p-0">
                        <details>
                            <summary className="btn mx-2 rounded-xl border border-green-300/10 p-3 font-bold text-green-300 shadow-xl shadow-green-300/10 transition hover:shadow-green-300">
                                <svg
                ...
                <div className="navbar-start hidden lg:flex">
                    <ul className="menu-horizontal menu-sm px-1">
                        <li>
                            <Link
                                href="/"
                                className="mx-2 flex rounded-xl border border-gray-300/10 p-3 font-bold text-gray-500 shadow-xl shadow-gray-300/10 transition hover:text-gray-500 hover:shadow-gray-300"
                            >
                                Home
                            </Link>
                        </li>
                        <li>
                            <Link
                                href="/about"
                                className="flex rounded-xl border border-blue-300/10 p-3 font-bold text-blue-500 shadow-xl shadow-blue-300/10 transition hover:text-blue-500 hover:shadow-blue-300"
                            >
                                Portfolio
                            </Link>
                        </li>
                        <li>
                            <Link
                                href="/practice"
                                className="mx-2 flex rounded-xl border border-pink-300/10 p-3 font-bold text-pink-500 shadow-xl shadow-pink-300/10 transition hover:text-pink-500 hover:shadow-pink-300"
                            >
                                Help For Develop
                            </Link>
                        </li>
