        ...
        <div className="navbar bg-base-100">
            <div className="navbar-start lg:hidden">
                ...
                <details className="dropdown">
                    <summary
                        className="btn mx-2 bg-base-100 rounded-xl border border-1 border-green-200 p-3 font-bold text-green-500 hover:text-green-700 shadow-xl shadow-green-300/10 transition hover:shadow-green-300">
                        <svg
            ...
            <div className="navbar-start hidden lg:flex">
                <ul className="menu-horizontal menu-sm px-1">
                    <li>
                        <Link
                            href="/"
                            className="mx-2 btn bg-base-100 flex rounded-xl border border-1 border-gray-200 p-3 font-bold text-gray-500 shadow-xl shadow-gray-300/10 transition hover:text-gray-700 hover:shadow-gray-300"
                        >
                            Home
                        </Link>
                    </li>
                    <li>
                        <Link
                            href="/about"
                            className="flex btn bg-base-100 rounded-xl border border-1 border-blue-200 p-3 font-bold text-blue-500 shadow-xl shadow-blue-300/10 transition hover:text-blue-700 hover:shadow-blue-300"
                        >
                            Portfolio
                        </Link>
                    </li>
                    <li>
                        <Link
                            href="/practice"
                            className="mx-2 btn bg-base-100 flex rounded-xl border border-1 border-pink-200 p-3 font-bold text-pink-500 shadow-xl shadow-pink-300/10 transition hover:text-pink-700 hover:shadow-pink-300"
                        >
                            Help For Develop
                        </Link>
                    </li>
                    <li>
                        <details className="dropdown cursor-pointer">
                            <summary
                                className="flex btn bg-base-100 rounded-xl border border-1 border-green-200 p-3 font-bold text-green-500 shadow-xl shadow-green-300/10 transition hover:shadow-green-300">
                                AI&nbsp;
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5"
