...
function Footer() {
    return (<footer className="container footer fixed bottom-0 items-center bg-neutral p-4 text-neutral-content">
        ...
        <div className="flex gap-4 justify-self-end">
            ...
            <Link href="https://www.linkedin.com/in/kim-jonggon-37ba19120/">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
